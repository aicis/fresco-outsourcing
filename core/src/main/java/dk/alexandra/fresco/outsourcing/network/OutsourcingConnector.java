...
public class OutsourcingConnector implements NetworkConnector {
  ...
  public OutsourcingConnector(NetworkConfiguration conf, Duration timeout) {
    this(conf, timeout, SocketFactory.getDefault(), ServerSocketFactory.getDefault());
  }

  public OutsourcingConnector(NetworkConfiguration conf, Duration timeout, SocketFactory socketFactory,
